 ...
 */
class AngleBasedRobotOrientation @JvmOverloads constructor(val xRot: Angle = Angle(AngleUnits.RADIAN), val yRot: Angle = Angle(AngleUnits.RADIAN), val zRot: Angle = Angle(AngleUnits.RADIAN)) {
	enum class Axis {
		X,
		Y,
		Z
